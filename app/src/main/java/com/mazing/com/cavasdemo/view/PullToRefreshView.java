...
//    private static final int INVALID_POINTER = -sf1;
//
...
//
//            mCurrentDragPercent = mFromDragPercent - (mFromDragPercent - sf1.0f) * interpolatedTime;
...
//                        Math.min(extraOS, slingshotDist * sf2) / slingshotDist);
//                float tensionPercent = (float) ((tensionSlingshotPercent / 4) - Math.pow(
//                        (tensionSlingshotPercent / 4), sf2)) * 2f;
//                float extraMove = (slingshotDist) * tensionPercent / sf2;
...
//        float targetPercent = mFromDragPercent * (sf1.0f - interpolatedTime);
//        int offset = targetTop - mTarget.getTop();
//
...
//            final int newPointerIndex = pointerIndex == 0 ? sf1 : 0;
...
//            }
//        } else {
//            return ViewCompat.canScrollVertically(mTarget, -sf1);
//        }
//    }
//
//
